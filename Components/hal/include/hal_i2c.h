 ...
 */
uint8 HalI2CReceive(uint8 address, uint8 *buf, uint16 len);
 ...
 * @return  zero when successful.
 */
uint8 HalI2CSend(uint8 address, uint8 *buf, uint16 len);

/*********************************************************************
 *
 * @fn		ADXL345Write
 * @brief	Write the data to the ADXL345
 * @param	
 *			regAddr -- ADXL345 reg to write
 *			val		-- value to write
 * @return	void
 */
void ADXL345WriteByte(uint8 address, uint8 value);

/*********************************************************************
 *
 * @fn		ADXL345Read
 * @brief	Read a ADXL345 register
 * @param	
 *			regAddr -- ADXL345 reg to Read
 *
 * @return	value read
 */
uint8 ADXL345ReadByte(uint8 address);
