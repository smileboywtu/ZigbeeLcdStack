...
// smileboy add reference here
// time: 2015/4/9
// the led comfigure is the same with the board made by waveshare
// so just safe to use it if you have move the sensor to other available pins
/* 1 - Green */
#define LED1_BV           BV(0)
...
// smileboy add reference here
// time: 2015/4/9
// here we are lukey to know it's also the same with the board made by waveshare
// so make sure it's available for the button
// keep care: you can use only buttton 1 and joystick center that's button 2
...
#ifndef HAL_LCD
//#define HAL_LCD TRUE
// smile boy add reference here
// time: 2015/4/9
// cause we get no LCD with the board so just do not compile this
...
/*****************************
Author: smileboy
ReverseTime: 2015/4/19
******************************/
#if (defined HAL_VIBRATE) && (HAL_VIBRATE == TRUE)
#define	HAL_LED FALSE
#endif
...
// Default preference for USART is DMA
#if HAL_UART
	#ifndef HAL_UART_DMA
		#if HAL_DMA
